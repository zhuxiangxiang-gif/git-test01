...
<head>
    ...
    <script type="text/javascript">
        ...
        //页面加载完毕之后就执行以下代码片段
        $(function () {
            var speakerId = '${videoList.spearkerId}';
...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/spearker/showSpearker.do" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="title" value="${videoList.title}" placeholder="视频名称">
            </div>
        </div>
                ...
                <div class="input-group">
                    <div class="input-group-btn">
                        ...
                        <ul id="selectSpeaker" class="dropdown-menu">
                            <c:forEach items="${videoList}" var="speaker">
                                <li value='${speaker.id}'><a href="#"
                                                             onclick="showName(this,'${speaker.id}',1)">${speaker.spearker.speakerName}</a>
                                </li>
                            </c:forEach>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                    ...
                    <input type="number" class="form-control" value="${videoList.changeTime}" name="changeTime" placeholder="精确到毫秒（正整数）">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="imageUrl" class="form-control" value="${videoList.imageUrl}" placeholder="具体的url">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="videoUrl" class="form-control" value="${videoList.videoUrl}" placeholder="具体的url">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name="detail" rows="3">${videoList.detail}</textarea>
            </div>
        </div>
