              ...
              $("#yzmBtn").click(function(){
                 ...
                 if(null!=email.val() && email.val()!=""){
                      //alert("====");
	                    ...
	                    email.load("${pageContext.request.contextPath}/user/sendEmail.action", params, function(data){
	                      if(data=="success"){
	                         alert("邮件发送成功");
	                      }else{
	                         alert("邮件发送失败");
...
<body>
    <header>
        <div class="container">
            <img src="${pageContext.request.contextPath}/img/logo.png" alt="城建">
        </div>
    </header>
    <main>
        <div class="container">
            <form class="ma" action="${pageContext.request.contextPath}/user/validateEmailCode.action">
