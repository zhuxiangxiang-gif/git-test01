...
<body class="w100">
    <header>
        <div class="container">
            <a href="www.baidu.com"></a><span>欢迎来到Y先生教育！</span>
    ...
    <nav class="w100">
        <div class="container">
            ...
            <ul class="text_13 f_right">
                <li>
                    <a href="${pageContext.request.contextPath}/listvideo.do" target="_blank">首页</a>
                </li>
                <li class="nav_down">
                    高端课程<img src="${pageContext.request.contextPath}/img/nav_down.png" alt="" draggable="false">
                    <ul id="nav_down" class="t_center">
                        <li>
                            <a target="_blank" href="www.baidu.com">Java国际</a>
                        </li>
                        <li>
        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course.action?subjectId=1">
                        ...
                        <td>
                            <!--上线时修改id-->
                            <a href="${pageContext.request.contextPath}/course.action?subjectId=6">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course.action?subjectId=10">
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course.action?subjectId=11">
