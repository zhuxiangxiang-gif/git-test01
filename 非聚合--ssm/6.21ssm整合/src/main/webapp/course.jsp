...
<head>
    ...
    <meta name="description" content="城建教育在线课程视频,为您提供java,python,HTML5,UI,PHP,大数据等学科经典视频教程在线浏览学习,精细化知识点解析,深入浅出,想学不会都难,城建教育,学习成就梦想！">
    <meta name="author" content="舒涛">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/base.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/css.css">
    <link rel="icon" href="favicon.png" type="image/png" />
    <title>在线公开课-城建教育|java|大数据|HTML5|python|UI|PHP视频教程</title>
...
<body class="w100">
    ...
    <nav class="w100">
        <div class="container">
            <img src="${pageContext.request.contextPath}/img/logo.png" alt="城建教育的logo" onclick="location.href='index.html'" draggable="false">
            <ul class="text_13 f_right">
                ...
                <li><a href="http://www.chengjian100.com/zyxw/ " target="_blank">城建新闻</a></li>
            </ul>
        </div>
    </nav>
    <div id="app" >
    ...
    <footer>
        <ul>
            ...
            <li class="mt25">
                <h3>校区地址</h3>
                <ul>
                    <li>地址<br>河南省平顶山市新华区龙翔大道河南城建学院</li>
        ...
        <div class="record">城建教育 &copy; 豫ICP备13012610号;河南城建学院</div>
    </footer>
    ...
    <script type="text/javascript">
        ...
        function getVideo(videoId){
        	...
        	if((null!="${sessionScope.userAccount}" && "${sessionScope.userAccount}" !="") || ($("#isLogin").val()==1)){
        		//如果登录
            	location.href="${pageContext.request.contextPath}/video/showVideo.action?videoId="+videoId+"&subjectName="+'${subject.subjectName}';
        	}else{
        		//如果不登录，弹登录框
